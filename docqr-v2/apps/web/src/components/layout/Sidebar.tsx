...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 17v-2a4 4 0 014-4h8M3 7h18M4 7h16v10a2 2 0 01-2 2H6a2 2 0 01-2-2V7z" />
      </svg>
    ),
    permission: 'admin:access',
  },
    ...
    <aside className="w-64 border-r bg-card h-screen sticky top-0">
      <div className="p-6">
        <Link to="/dashboard" className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold">DOCQR</span>
        </Link>
      </div>
